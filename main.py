...
def main(dataset_name='expt_eform', n_head_layers=3,
    ...
    train_dl = DataLoader(
        train_subset, batch_size=64, num_workers=0, shuffle=True,
        collate_fn=collate_pool)
    val_dl = DataLoader(
        val_subset, batch_size=64, num_workers=0, shuffle=True,
        collate_fn=collate_pool)
    test_dl = DataLoader(
        test_subset, batch_size=64, num_workers=0, shuffle=True,
        collate_fn=collate_pool)
